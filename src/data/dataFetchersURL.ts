...
/* StatementMission */
export const statementMissionURL: string =
  "http://localhost:3001/statementMission";

/* CollectionsByGender */
export const collectionsByGenderURL: string =
  "http://localhost:3001/collectionsByGender";
