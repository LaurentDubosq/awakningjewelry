...
export const useHeroSlidesResultStore = defineStore("HeroSlidesResult", () => {
  // States
  const heroSlidesResult: Ref<
    undefined | UseFetchWithStateReturn<HeroSlideType[]>
  > = ref();
  ...
  // Methods
  const updateHeroSlidesResult = (
    newSlidesResult: UseFetchWithStateReturn<HeroSlideType[]>
  ) => {
