...
const mockWordingInputPlaceholder = mockWording.form.inputPlaceholder
const mockWordingInputTitle = mockWording.form.inputTitle
const mockWordingLabel = mockWording.form.label
const mockWordingButtonText = mockWording.form.buttonText
