...
describe("Slideshow.vue", () => {
  ...
  describe("SlideshowAutorotationButton.vue", () => {
    test("render the component with necessary information", () => {
      const SlideshowSlickSliderComponent = wrapper.findComponent(
  ...
  describe("SlideshowSlickSlider.vue", () => {
    ...
    test("render the component with necessary information", () => {
      const SlideshowSlickSliderComponent =
        wrapper.findComponent(SlideshowSlickSlider);
      ...
      expect(SlideshowSlickSliderComponent.props("currentIndex")).toBe(
        mockCurrentIndex
      );
    });
    ...
    describe("Behaviors:", () => {
      ...
      test("when the home key is pressed, it displays the first slide, and the first slick slider button is focused", async () => {
        const slickSliderButtons = wrapper.findAll(
          "[data-testid='slideshow__slick-slider-button']"
        );
  ...
  describe("Behaviors:", () => {
    ...
    test("when user focus a slick slider button, the autorotation is stopped, then start again when the 'play' button is clicked", async () => {
      ...
      const slickSliderButton = wrapper.find(
        "[data-testid='slideshow__slick-slider-button']"
      );
      ...
      const autorotationButton = wrapper.find(
        "[data-testid='slideshow__autorotation-button']"
      );
    ...
    test("when user navigates using the 'tab' key, the slick slider buttons should be focused before the slide content in the tab sequence", () => {
      ...
      const slickSliderPosition = focusableElements.indexOf(
        firstSlickSliderButton.element
      );

      // Get the slide content focusable button/link position
      const slideContentButton = wrapper.find(
        "[data-testid='hero__slide-link']"
      );
      const slideContentButtonPosition = focusableElements.indexOf(
        slideContentButton.element
      );
