    ...
    test('Cart link is rendered with necessary information for both environment', () => {
      ...
      expect(link.html()).toMatchInlineSnapshot(`
        "<a data-v-a8a65ae7="" title="Go to cart" data-testid="site-header__cart-link">
          <div data-v-e69856ec="" data-v-a8a65ae7="" class="site-header__icon-clickable-area"><svg data-v-3259e777="" data-v-a8a65ae7="" class="icon-cart site-header__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" data-testid="icon-cart" width="27" aria-hidden="true">
              <path data-v-3259e777="" fill-rule="evenodd" d="M2.5 3.75a.75.75 0 0 1 .75-.75h1.612a1.75 1.75 0 0 1 1.732 1.5h9.656a.75.75 0 0 1 .748.808l-.358 4.653a2.75 2.75 0 0 1-2.742 2.539h-6.351l.093.78a.25.25 0 0 0 .248.22h6.362a.75.75 0 0 1 0 1.5h-6.362a1.75 1.75 0 0 1-1.738-1.543l-1.04-8.737a.25.25 0 0 0-.248-.22h-1.612a.75.75 0 0 1-.75-.75Zm4.868 7.25h6.53a1.25 1.25 0 0 0 1.246-1.154l.296-3.846h-8.667l.595 5Z"></path>
              <path data-v-3259e777="" d="M10 17a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"></path>
              <path data-v-3259e777="" d="M15 17a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"></path>
    ...
    test('My account link is rendered with necessary information', () => {
      ...
      expect(link.html()).toMatchInlineSnapshot(`
        "<a data-v-a8a65ae7="" title="Go to my account" data-testid="site-header__account-link">
          <div data-v-e69856ec="" data-v-a8a65ae7="" class="site-header__icon-clickable-area"><svg data-v-a16918d6="" data-v-a8a65ae7="" class="icon-person site-header__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" data-testid="icon-person" width="27" aria-hidden="true">
              <path data-v-a16918d6="" fill-rule="evenodd" d="M10 3a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7Zm-2 3.5a2 2 0 1 1 4 0 2 2 0 0 1-4 0Z"></path>
              <path data-v-a16918d6="" fill-rule="evenodd" d="M15.484 14.227a6.274 6.274 0 0 0-10.968 0l-.437.786a1.338 1.338 0 0 0 1.17 1.987h9.502a1.338 1.338 0 0 0 1.17-1.987l-.437-.786Zm-9.657.728a4.773 4.773 0 0 1 8.346 0l.302.545h-8.95l.302-.545Z"></path>
